...
Route::get('/listado-empresas/editar', 'EmpresaController@editar');
...
Route::get('/listado-contacto/editar', 'ContactoController@editar');
...
Route::get('/listado-mas-informacion/editar', 'MasInformacionController@editar');
Route::get('/listado-te-llamamos', 'TeLlamamosController@consulta')->name('listado-te-llamamos');
Route::get('/listado-te-llamamos/editar', 'TeLlamamosController@editar');
