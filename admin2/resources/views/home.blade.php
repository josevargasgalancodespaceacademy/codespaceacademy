...
@section('css')
 ...
 <link href='plugins/fullcalendar/AdminLTE-fullcalendar.css' rel="stylesheet"> 
...
<div class="panel panel-default">
    ...
    <div class="panel-heading"><h2> Calendario citas y eventos</h2>  </div>
        ...
        <div class="col-md-3">
          <div class="box box-solid">
            <div class="box-header with-border">
              <h4 class="box-title">Eventos predeterminados</h4>
            </div>
            <div class="box-body">
              <!-- the events -->
          ...
          <div class="box box-solid">
            ...
            <div class="box-body">
              ...
              <!-- /input-group -->
              {!! Form::open(['route' => ['guardareventos'], 'method' => 'POST', 'id' =>'form-calendario']) !!}
              {!! Form::close() !!}
            </div>
          </div>
        </div>
