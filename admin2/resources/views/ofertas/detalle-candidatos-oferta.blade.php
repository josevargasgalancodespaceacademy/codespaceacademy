...
<table class="table table-bordered">
	...
	<tr>
			...
			<td><a href="https://www.codespaceacademy.com/curriculums/{{ $fecha_ingreso = \Carbon\Carbon::parse($detalle_candidato->created_at)->format('Y-m-d')}}-{{ $detalle_candidato->route_curriculum_pdf }}" target="_blank">{{ $detalle_candidato->route_curriculum_pdf }}</a></td>
