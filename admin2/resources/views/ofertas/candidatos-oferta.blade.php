...
<table class="table table-bordered">
	...
	<tr>
			...
			<td><a href="../public/listado-curriculums/{{ $registro->offer_id }}/candidatos/{{$registro->id}}/detalle-candidato" class="btn btn-info"><span class="glyphicon glyphicon-zoom-in" aria-hidden="true"></span> Ver más </a></td>
	</tr>	
	@endforeach
</tbody>
</table>
