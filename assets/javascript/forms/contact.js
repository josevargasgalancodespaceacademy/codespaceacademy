function enviar_contact_form(){
  ...
  $.ajax({                        
    ...
    var postData = $("#formulario-contacto").serializeArray().reduce(function(obj, item) {
    obj[item.name] = item.name;
    return obj;
    }, {});
    var originalData = $("#formulario-contacto").serializeArray().reduce(function(obj, item) {
    ...
    if( respuesta == "\nOK") {
      ...
      $('#formulario-contacto .mensajerror').css('display', 'inline-block');
