...
<head>
    ...
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css"> @yield('css')
</head>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" aria-haspopup="true">
                                    Gestión de Bootcamps <span class="caret"></span>
                                </a>
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="{{ route('listado-usuarios')}}">Asignar horas</a>
                                </li>
                                <li>
                                    <a href="{{ route('register')}}">Añadir nueva edición</a>
                                </li>
                                <li>
                                    <a href="{{ route('listado-usuarios')}}">Asignar profesores</a>
                                </li>
                            </ul>
                        </li>
                        <li class="dropdown">
