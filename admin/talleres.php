...
<nav class="menu">
    <ul>
     ...
     <li style="list-style: none; float: right; right: 0px; top: 0px!important;" >
 ...
 <?php
                foreach ($company as $key => $company_contacts) {
                  echo "<tr><td>".$company[$key]["name"]."</td><td>".$company[$key]["email"]."</td><td>".$company[$key]["telephone"]."</td><td>".$company[$key]["created_at"]."</td></tr>";
                }
               ?>        
  </table>
  </div> 
